...
# HTML dosyasını oku ve main.py içine HTMLResponse olarak göm
    ...
    <div class="container">
        ...
        <div class="upload-box">
            <form id="uploadForm" onsubmit="handleUpload(event)">
                ...
                <input type="file" id="fileInput" name="file" required style="width: 100%; margin-top: 5px; margin-bottom: 15px;">
                
                <label for="speakerSelect">Ses Profili (Konuşmacı Seçimi):</label>
                <select id="speakerSelect" name="speaker" style="width: 100%; margin-top: 5px; margin-bottom: 20px;">
                    <option value="">Yükleniyor...</option>
                </select>

                <button type="submit" id="submitBtn" style="width: 100%;">Kitabı Yükle ve Sese Dönüştür</button>
            </form>
...
# HTMLResponse import'unu ve root route'u güncelle
if "from fastapi.responses import HTMLResponse" not in code:
    code = "from fastapi.responses import HTMLResponse\n" + code

# Eski root route tanımını bul ve değiştir
old_route_pattern = r'@app\.get\("/"\).*?(?=@app\.|\Z)'
